...
import { Plus, Search, Filter, Edit3, MoreVertical, PackageOpen } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col bg-gray-50/50">
      <div className="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6">
        <div>
          <h1 className="text-lg font-bold text-gray-900 leading-tight">Variants</h1>
          <p className="text-xs font-medium text-gray-500">Manage item sizes and crust variations</p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">No Variants Defined Yet</h2>
          <p className="text-gray-500 max-w-sm mx-auto mb-6">Create variant groups like 'Size' or 'Crust' and assign them to your menu items to offer custom pricing.</p>
          <button className="rounded-lg bg-[#00D9D9] px-6 py-2.5 text-sm font-bold text-white shadow-[0_4px_15px_rgb(0,217,217,0.2)] hover:opacity-90 transition-opacity mx-auto inline-flex items-center gap-2">
            <Plus className="h-4 w-4" /> Create First Variant Group
          </button>
        </div>
      </div>
    </div>
